...
#define motorLFA 6  // sol motor kirmizi pin
#define motorLBA 7  // sol motor siyah pin
...
PID myPIDRound(&InputRound, &OutputRound, &SetPointRound, 10, 0, 0, DIRECT);
